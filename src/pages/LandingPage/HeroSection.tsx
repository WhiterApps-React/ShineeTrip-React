              ...
              <div className="flex  gap-8  overflow-x-auto no-scrollbar pb-1">
                {categories.map((cat) => (
                  <button
                    ...
                    className={`pb-3 whitespace-nowrap transition-all relative text-[18px] font-opensans ${activeTab === cat.name ? "text-gray-900" : "text-gray-500 hover:text-gray-700"
                      }`}
                  >
                    {cat.name}
                    {activeTab === cat.name && (
            ...
            <div className="relative">
              ...
              <div className="flex justify-center gap-4 mt-3">
                <button
                  ...
                  className={`w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center transition-all ${slideIndex === 0
                ...
                <button
                  ...
                  className={`w-12 h-12 rounded-full bg-gray-200 flex items-center justify-center transition-all ${slideIndex >= maxSlide
                      ? "text-gray-400 cursor-not-allowed"
                      : "hover:bg-[#C9A961] hover:text-white"
                    }`}
                >
